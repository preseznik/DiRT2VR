...
| `0x330b70` | Camera conversion/constant setup, including SSE transformations |
...
| `0x331796` / `0xba1904` | Leads around camera constant upload; not installed hooks |
