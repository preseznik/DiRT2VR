...
& (Join-Path $repo 'tests/lan_settings.ps1')
...
Copy-Item -LiteralPath "$PSScriptRoot/LanFiles.ps1","$PSScriptRoot/LanSettings.ps1","$PSScriptRoot/Lan-Settings.cmd","$PSScriptRoot/Start-LanTest.ps1","$PSScriptRoot/Start-LanTest.cmd","$PSScriptRoot/README.txt" -Destination $kit
...
Copy-Item -LiteralPath 'src/common.cpp','src/common.h','tests/lan_profile_test.cpp','tests/lan_intro_test.cpp' -Destination "$kit/source/DiRT2VR-lan"
$files=[ordered]@{}
